...
#   (lazy is direction-agnostic; only the queries care about ordering)
#
...
#
#
# hld = LazyHLDEdge(numNodes, edgeList, base, combine, applyLazy, composeLazies, reverse)
# =============================================================================

class LazyHLDEdge:
    def __init__(self, n, edges, base, combine, applyLazy, composeLazies, reverse):
        self.n = n
        self.base = base
