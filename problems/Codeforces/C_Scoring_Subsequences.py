...
for _ in range(t):
    ...
    # the maximum length of the subsequence of some numbers if when sorted in reverse
    # we take the longest prefix s.t. the ending value is >= the amount of numbers we take
    sl = SortedList()
    res = []
    for i in range(len(arr)):
        # prefix is 0...i
        sl.insert(arr[i])
        # binary search on longest suffix s.t. smallest element in suffix is >= the length of
        biggest = sl.longestSuff()
        res.append(biggest)
