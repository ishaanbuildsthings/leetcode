...
int main() {
    ...
    vector<Query> queries; {
        for (int i = 0; i < q; i++) {
            int l, r, low, high; cin >> l >> r >> low >> high;
            l--; r--;
            Query q1 = {0, r, low, high, i, 1};
            queries.push_back(q1);
            if (l) {
                Query q2 = {0, l - 1, low, high, i, -1};
    ...
    for (Query query : queries) {
        ...
        res[query.queryId] += os.countInRange(query.low, query.high) * query.sign;
    }
