...
/*
This question is NOT asking us to implement a hash table in any way. We don't have to because hashtables don't support O(1) get random. The main crux of the problem is supporting the O(1) get random, so we are allowed to use hash tables.
