...
// Solution
// O(n * mlogm) with a normal sort, or O(n*m) time with a bucket/counting sort. and O(n*k) space, since for each word we may need to store the entire word in memory, and the word is k letters
